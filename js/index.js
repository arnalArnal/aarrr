...
MainLeft.addEventListener('click', () => {
    fetch('http://api.openweathermap.org/data/2.5/weather?q=moscow&appid=946eb4a4d72dd907a1d201ba481e7242')
...
MainLeft1.addEventListener('click', () => {
    fetch('http://api.openweathermap.org/data/2.5/weather?q=london&appid=946eb4a4d72dd907a1d201ba481e7242')
    .then(function (resp) {return resp.json() })
    .then(function (data) {
        console.log(data);
        document.querySelector('.city').innerHTML = data.name;
...
MainLeft2.addEventListener('click', () => {
    fetch('http://api.openweathermap.org/data/2.5/weather?q=tokyo&appid=946eb4a4d72dd907a1d201ba481e7242')
    .then(function (resp) {return resp.json() })
    .then(function (data) {
        console.log(data);
        document.querySelector('.city').innerHTML = data.name;
...
MainLeft4.addEventListener('click', () => {
    fetch('http://api.openweathermap.org/data/2.5/weather?q=istanbul&appid=946eb4a4d72dd907a1d201ba481e7242')
    .then(function (resp) {return resp.json() })
    .then(function (data) {
        console.log(data);
        document.querySelector('.city').innerHTML = data.name;
...
MainLeft5.addEventListener('click', () => {
    fetch('http://api.openweathermap.org/data/2.5/weather?q=bishkek&appid=946eb4a4d72dd907a1d201ba481e7242')
    .then(function (resp) {return resp.json() })
    .then(function (data) {
        console.log(data);
        document.querySelector('.city').innerHTML = data.name;
